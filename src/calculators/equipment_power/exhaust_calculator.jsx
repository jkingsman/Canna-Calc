            ...
            <div>
                ...
                <div className="row">
                    <div className="col-sm">
                        ...
                        <FixedUnitInput inputLabel="Fan Count" onChange={(val) => this.setState({fanCount: Number(val)})} number={this.state.fanCount} unit="fans"/>
                        <FixedUnitInput inputLabel="Exchange Time" onChange={(val) => this.setState({exchangeTime: Number(val)})} number={this.state.exchangeTime} unit="minutes to total air flush"/>
                    </div>
                    <div className="col-sm">

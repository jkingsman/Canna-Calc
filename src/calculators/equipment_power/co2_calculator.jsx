            ...
            <div className="container">
                ...
                <EquationBlock
                    equations={[
                        ...
                        "Fixed Addtl. CO₂ = (Desired Addtl. CO₂ * 1e-6) * Room Volume",
                ...
                <div className="row">
                    <div className="col-sm">
                        ...
                        <FixedUnitInput
                            ...
                            onChange={val => this.setState({ ambientPPM: Number(val) })}
                            number={this.state.ambientPPM}
                            unit="ppm"
                        />
                        <FixedUnitInput
                            inputLabel="Desired CO₂"
                            onChange={val => this.setState({ desiredPPM: Number(val) })}
                            number={this.state.desiredPPM}
                            unit="ppm"
                        />
                        <FixedUnitInput
                            inputLabel="Minutes On"
                            onChange={val => this.setState({ minutesOn: Number(val) })}
                    ...
                    <div className="col-sm">
                        ...
                        <FixedUnitOutput
                            noColon
                            number={defaultRound(this.getTimedFtHrFlowRate() / 60)}
                            unit="SCFM (ft³/min)"
                        />
                    </div>
                </div>

            ...
            <div>
                ...
                <div className="row">
                    <div className="col-sm">
                        ...
                        <FixedUnitInput inputLabel="Fertilizer P" number={this.state.p} onChange={(val) => this.setState({p: Number(val)})} unit=""/>
                        <FixedUnitInput inputLabel="Fertilizer K" number={this.state.k} onChange={(val) => this.setState({k: Number(val)})} unit=""/>
                        ...
                        <FixedUnitInput inputLabel="S.G. Override*" number={this.state.sg} onChange={(val) => this.setState({sg: Number(val)})} unit=""/>
                    </div>
                    <div className="col-sm">
                ...
                <i>*In cases of a %w/v solution, enter the specific gravity of the fertilizer to correct for non-1.0 S.G. conversions.</i>
            </div>
        );
    }
}

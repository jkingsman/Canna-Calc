        ...
        return (
            <div>
                ...
                <AccordionContainer id="generalAccordion" padLeft>
                    <CardTemplate id="weightConversion" keywords="weight mass grams ounces oz pounds lbs milligrams mg stone st kilograms kilos kg" searchTerm={this.state.searchTerm} title="Weight Conversion" parentID="generalAccordion">
                        <GeneralCalculatorTemplate labelSuffix="Weight" conversionFactors={ConversionFactors.weight}/>
                    </CardTemplate>

                    <CardTemplate id="temperatureConversion" keywords="temperature heat celsius centigrade farenheit kelvin" searchTerm={this.state.searchTerm} title="Temperature Conversion" parentID="generalAccordion">
                        <GeneralCalculatorTemplate labelSuffix="Temperature" conversionFactors={ConversionFactors.temperature} negative hideSplitter/>
                    </CardTemplate>

                    <CardTemplate id="distanceConversion" keywords="distance length height width meters millimeters mm centimeters cm kilometers km inches feet ft yards yd miles" searchTerm={this.state.searchTerm} title="Distance Conversion" parentID="generalAccordion">
                    ...
                    <CardTemplate id="volumeConversion" keywords="volume amount cubic ^3 meters m^3 cc centimeters cm^2 cups fluid ounces fl oz floz feet ft^3 gallons in^3 inches kilometers km^3 liters milliliters ml miles mi^3 millimeters mm^3 pints quarts qts tablespoons tbsp teaspoons tsp yards yd^3" searchTerm={this.state.searchTerm} title="Volume Conversion" parentID="generalAccordion">
                    ...
                    <CardTemplate id="percentChange" keywords="% percent change after" searchTerm={this.state.searchTerm} title="Percent Change" parentID="generalAccordion">
                        <PercentChange/>
                    </CardTemplate>

                    <CardTemplate id="cylinderVolume" keywords="cylinder fan exhaust ducting volume" searchTerm={this.state.searchTerm} title="Cylinder (Ducting) Volume" parentID="generalAccordion">
                        <CylinderCalculator/>
                    </CardTemplate>
                </AccordionContainer>
                ...
                <AccordionContainer id="growingAccordion" padLeft>
                    ...
                    <CardTemplate id="co2FlowRate" keywords="co2 fan carbon dioxide ppm scfh scfm regulator gas" searchTerm={this.state.searchTerm} title="CO₂ Flow Rate" parentID="growingAccordion">
                        <CO2Calculator/>
                    </CardTemplate>

                    <CardTemplate id="exhaustCFM" keywords="fan air flow exchange exhaust scfm power" searchTerm={this.state.searchTerm} title="Exhaust CFM Calculator" parentID="growingAccordion">
                        <ExhaustCalculator/>
                    </CardTemplate>

                    <CardTemplate id="amperageCalculator" keywords="lighting lights led hid kwh power cost hours amps amperage electricity volts voltage" searchTerm={this.state.searchTerm} title="Light kWh &amp; Cost" parentID="growingAccordion">
                        <AmperageCalculator/>
                    </CardTemplate>

                    <CardTemplate id="waterCalculator" keywords="water usage cost gallon gal cubic foot unit" searchTerm={this.state.searchTerm} title="Water Usage &amp; Cost" parentID="growingAccordion">
                        <WaterCalculator/>
                    </CardTemplate>
                    ...
                    <CardTemplate id="plantCountCalculator" keywords="growing layout grid space sqft square footage feet width length size" searchTerm={this.state.searchTerm} title="Plant Layout" parentID="growingAccordion">
                        <PlantCount/>
                    </CardTemplate>
                </AccordionContainer>
                ...
                <AccordionContainer id="concentratesEdiblesAccordion" padLeft>
                    <CardTemplate id="potency" keywords="medibles thc potency mg milligrams grams ml ejuice vape vaporizer liquid wax oil concentrate extract baking cannaoil cannabutter" searchTerm={this.state.searchTerm} title="THC/Potency Conversions" parentID="concentratesEdiblesAccordion">
                    ...
                    <CardTemplate id="decarbLoss" keywords="decarboxylation thca" searchTerm={this.state.searchTerm} title="Decarboxylation Loss" parentID="concentratesEdiblesAccordion">
                        <DecarbLoss/>
                    </CardTemplate>

                    <CardTemplate id="extractionEfficiency" keywords="extract concentrate wax oil shatter bho efficiency feedstock" searchTerm={this.state.searchTerm} title="Extraction Efficiency" parentID="concentratesEdiblesAccordion">
                        <ExtractionEfficiency/>
                    </CardTemplate>

                    <CardTemplate id="evapPrediction" keywords="solvent evaporation concentrate extract wax oil shatter bho" searchTerm={this.state.searchTerm} title="Solvent Evaporation Time Estimate" parentID="concentratesEdiblesAccordion">
                        <EvapPrediction/>
                    </CardTemplate>

                    <CardTemplate id="ediblePotency" keywords="thc potency mg milligrams grams ml ejuice vape vaporizer liquid wax oil concentrate extract baking cannaoil cannabutter servings size medibles" searchTerm={this.state.searchTerm} title="Edible Potency" parentID="concentratesEdiblesAccordion">

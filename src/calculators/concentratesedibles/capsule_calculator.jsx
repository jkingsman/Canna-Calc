            ...
            <div className="container">
                <div>
                    ...
                    <EquationBlock equations={[
                        ...
                        "",
                        "Cap/Cart Cannabinoids = Sum of All Cannabinoids per Cap/Cart",
                        "",
                ...
                <div className="row">
                    ...
                    <div className="col-sm">
                        <GenericOutput
                            outputLabel="Cap/Cart THC*"
                            number={defaultRound(this.getCannabinoids()[0])}
                            conversionFactors={ConversionFactors.tinyVolume}
                            showSplitter={false}
                        />
                        <GenericOutput
                            outputLabel="Cap/Cart THCa*"
                            number={defaultRound(this.getCannabinoids()[1])}
                            conversionFactors={ConversionFactors.tinyVolume}
                            showSplitter={false}
                        />
                        <GenericOutput
                            outputLabel="Cap/Cart Δ-8 THC*"
                            number={defaultRound(this.getCannabinoids()[2])}
                            conversionFactors={ConversionFactors.tinyVolume}
                            showSplitter={false}
                        />
                        <GenericOutput
                            outputLabel="Cap/Cart CBD*"
                            number={defaultRound(this.getCannabinoids()[3])}
                            conversionFactors={ConversionFactors.tinyVolume}
                            showSplitter={false}
                        />
                        <GenericOutput
                            outputLabel="Cap/Cart CBN*"
                            number={defaultRound(this.getCannabinoids()[4])}
                            conversionFactors={ConversionFactors.tinyVolume}
                            showSplitter={false}
                        />
                        <GenericOutput

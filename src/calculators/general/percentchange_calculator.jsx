            ...
            <div className="container">
                <div className="row">
                    <div className="col-sm">
                        <FixedUnitInput inputLabel="Before" onChange={(val) => this.setState({before: Number(val)})} number={this.state.before} unit="units"/>
                        <FixedUnitInput inputLabel="After" onChange={(val) => this.setState({after: Number(val)})} number={this.state.after} unit="units"/>
                    </div>
                    <div className="col-sm">

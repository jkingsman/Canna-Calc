...
export default class DateCalculator extends React.Component {
    ...
    isTimeValid() {
        ...
        if (
            Number(components[0]) >= 24 ||
            Number(components[1]) >= 60 ||
            Number(components[2]) >= 60
        ) {
            return "❌";
        }
    ...
    getFinalDateISO() {
        ...
        if (this.state.action === "add") {
            adjusted = original
                .add(this.state.years, "year")
                .add(this.state.months, "month")
                .add(this.state.days, "day")
                .add(this.state.hours, "hour")
                .add(this.state.minutes, "minute")
                .add(this.state.seconds, "second");
        } else {
            adjusted = original
                .subtract(this.state.years, "year")
                .subtract(this.state.months, "month")
                .subtract(this.state.days, "day")
                .subtract(this.state.hours, "hour")
                .subtract(this.state.minutes, "minute")
                .subtract(this.state.seconds, "second");
        }
